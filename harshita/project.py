...
#     "Sauté tofu and broccoli with ginger",
...
#     "Sauté potato and cauliflower with turmeric and cumin",
...
# st.markdown("<h1 style='text-align:center;color:#6a0dad;'>🍽 Smart Recipe Generator</h1>", unsafe_allow_html=True)
...
if user_input:
    ...
    if not filtered_df.empty:  # ✅ check if dataframe is not empty
        ...
        st.warning("⚠️ No recipes available for this cuisine/search. Try another filter!")
